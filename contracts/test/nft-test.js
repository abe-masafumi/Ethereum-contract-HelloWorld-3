...
describe("NFT", async function () {
  ...
  it("should be able to mint, transferFrom, burn. And it should return appropriate name, symbol, totalSupply, tokenURI, ownerOf, balanceOf", async function () {
    ...
    await nft.deployed();
    console.log(`nft deploy tx: https://ropsten.etherscan.io/tx/${nft.deployTransaction.hash}`);//t追加
    ...
    console.log(`transfer1FromSignerToAddress tx: https://ropsten.etherscan.io/tx/${transfer1FromSignerToAddressTx.hash}`);
    ...
    console.log(`transfer2FromBadSignerToSignerAddress tx: https://ropsten.etherscan.io/tx/${transfer2FromBadSignerToSignerAddressTx.hash}`);
